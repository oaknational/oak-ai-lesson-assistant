## Version v1.1.42
## What's Changed\r\n* Llm response json schema by @mantagen in https://github.com/oaknational/ai-beta/pull/784\r\n* fix: playwright clerk app name by @simonrose121 in https://github.com/oaknational/ai-beta/pull/791\r\n* Moderation Context Provider by @stefl in https://github.com/oaknational/ai-beta/pull/785\r\n* Server actions fixes and refactor by @mantagen in https://github.com/oaknational/ai-beta/pull/756\r\n* bug: fix streaming lesson plan by @tomwisecodes in https://github.com/oaknational/ai-beta/pull/801\r\n* Make demo message limit customisable with an env var by @codeincontext in https://github.com/oaknational/ai-beta/pull/799\r\n* Fix/history order by @mantagen in https://github.com/oaknational/ai-beta/pull/797\r\n* Require demo user metadata on backend when checking demo status by @codeincontext in https://github.com/oaknational/ai-beta/pull/796\r\n* Don't send demo status to frontend analytics until it's known by @codeincontext in https://github.com/oaknational/ai-beta/pull/795\r\n* Feat/in app db by @tomwisecodes in https://github.com/oaknational/ai-beta/pull/802\r\n* Fix incorrect demo chat completion keys by @codeincontext in https://github.com/oaknational/ai-beta/pull/798\r\n* Add missing NEXT_PUBLIC_ demo env var prefix by @codeincontext in https://github.com/oaknational/ai-beta/pull/803\r\n* Fix Helicone and add "session id" by @mantagen in https://github.com/oaknational/ai-beta/pull/793\r\n* Fix downloads page: Revert useLessonChat hook by @codeincontext in https://github.com/oaknational/ai-beta/pull/807\r\n**Full Changelog**: https://github.com/oaknational/ai-beta/compare/v1.1.41...v1.1.42-rc2
