...
export const FAQPageContent = () => {
  ...
  const scrollToRefWithOffset = (ref: React.RefObject<HTMLDivElement | null>) => {
    if (ref?.current) {
        ...
        <OakBoxCustomMaxWidth customMaxWidth={850}>
          ...
          <div className="mb-4">
            ...
            <OakP>
              ...
              use. There are some fair use limits that we have applied that you
              may reach if your use appears to be excessive.
            </OakP>
            <OakHeading
              tag="h3"
              $font="body-1-bold"
            ...
            <OakP>
              We aim to make our resources as accessible as possible. Aila will
              be available to any teacher with access to a laptop or computer
              and the Internet. We currently don&apos;t support mobile usage.
            </OakP>
            <OakHeading
              tag="h3"
              $font="body-1-bold"
            ...
            <OakP>
              Aila provides helpful tips and prompts for getting started. If you
              need additional support, you can take a look at our{" "}
          ...
          <div className="mb-4">
            ...
            <OakP>
              ...
              high-quality lesson plans and resources. It is designed to ensure
              that lesson plans meet national curriculum standards. You can edit
              your lesson plan using Aila, quickly generating downloadable
              lesson plans, editable slide decks, and starter and exit quizzes.
              You may also choose to adapt or add to the resources after
              download.
            </OakP>
            <OakHeading
              tag="h3"
            ...
            <OakP>
              ...
              your lesson will be. You can ask Aila to adapt the lesson to suit
              your geographical context, the reading age of students in your
              class, or any other additional needs your pupils may have. The
              materials you produce with Aila are also fully editable.
            </OakP>
            <OakHeading
              tag="h3"
              $font="body-1-bold"
            ...
            <OakP $mb="spacing-16">
              ...
              won&apos;t produce your generic off-the-shelf lesson; it will help
            ...
            <OakP $mb="spacing-16">
              ...
              accuracy of the lessons being produced. Aila has been designed for
              UK teachers so you are less likely to see Americanisms and the
              content will be more closely aligned with the English national
              curriculum.
            </OakP>
            <OakHeading
              tag="h3"
            ...
            <OakP>
              ...
              users. With Aila, you&apos;re less likely to see Americanisms, and
              the content will align much more closely with the requirements of
              teachers in England.
            </OakP>
            <OakHeading
              tag="h3"
            ...
            <OakP $mb="spacing-16">
              ...
              Aila, but to help teachers with this aspect of lesson design, we
              currently provide an &apos;image suggestion&apos; to help you find
            ...
            <OakP>
              ...
              learning and cognitive science, which has formed the structure of
              the lessons that Aila produces. All outputs are fully editable, so
              you can update them to your preferred formats.
            </OakP>
            <OakHeading
              tag="h3"
              $font="body-1-bold"
            ...
            <OakP>
              ...
              assessing pupils&apos; mastery of content, but they take a really
              long time to write, so we have included lots to save you time.
              After export, you can edit these to remove the options and make
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              navigate most of the website using just a keyboard; navigate most
              ...
              <OakLink href="/legal/accessibility-statement">
            ...
            <OakP $mb="spacing-16">
              ...
              activities to support pupils during the additional materials
              section of the lesson. You are also able to download and edit all
              resources after you have created your lesson.
            </OakP>
          </div>
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              explanations or texts differentiated by reading age for your
              classes, just ask at the end of the lesson planning process and
              Aila will create these for you.
            </OakP>
          </div>
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              content produced should be closely aligned with the needs of
              teachers in England.
            </OakP>
          </div>
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              produce images and diagrams. We are also developing Aila to ensure
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              in place a number of technical and policy measures to minimise the
              risks that generative AI presents but care should still be taken,
              for example, you must not input personally identifiable
              information into Aila, and this is in breach of the terms and
              conditions of use.
            </OakP>
            ...
            <OakP $mb="spacing-16">
              ...
              looked into emerging guidance and governance on generative AI,
              including;
            </OakP>
          ...
          <div>
            ...
            <OakP $mb="spacing-16">
              ...
              &apos;oak tree&apos; in Hebrew, and in Scottish Gaelic, Aila means
              &apos;from the strong place&apos;. We believe the rigour and
              quality of Aila stems from the strong foundation provided by both
