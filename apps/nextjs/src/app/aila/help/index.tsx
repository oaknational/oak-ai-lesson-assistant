    ...
    <div className="mx-auto mt-30 h-[100vh] w-full max-w-[1280px] px-9">
      <div className="mb-27 flex justify-between gap-3">
        ...
        <div className="mb-40 max-w-[800px]">
          ...
          <p className="mb-4">
            Create your first lesson by typing a lesson title and key stage into
            the input box on the first screen and clicking the arrow key. This
            will create the starting point of your lesson. You can get back to
            the initial screen by clicking &apos;New lesson&apos; in the main
            navigation.
          </p>
          ...
          <p className="mb-4">
            Once the lesson has been created (and all sections are complete) you
            will be able to download the following documents:
          </p>
          <ul className="mb-6 list-disc pl-12">
          ...
          <p className="mb-4">
            ...
            process of co-creating each section of your lesson on the left-hand
            side of the screen. The lesson output will be generated on the
            right-hand side.
          </p>
          ...
          <ul className="mb-6 list-disc pl-12">
            ...
            <li>add specific case studies or examples to your explanations.</li>
          ...
          <p className="mb-4">
            When you have completed all the sections in the lesson, you will be
            able to download the lesson resources, including the full lesson
            plan (which includes all sections), editable slides and starter and
            exit quizzes. You can also share your lesson as a link, which can be
            viewed online.
          </p>
          ...
          <p className="mb-4">
            Retrieval Augmented Generation is used to integrate Oak content into
            your lessons, improving the accuracy of the content produced. AI is
            not 100% accurate and mistakes can still be made. Remember,
