          ...
          >
            ...
            <OakBox ref={startingRef}>
              ...
              <OakP>
                ...
                into the input box on the first screen and clicking the arrow
                key. This will create the starting point of your lesson. You can
                get back to the initial screen by clicking &apos;New
            ...
            <OakBox ref={downloadingRef}>
              ...
              <OakP $mb={"space-between-xs"}>
                ...
                slides, starter and exit quizzes, a worksheet with your practice
                tasks, and any additional materials you’ve created. You can also
                share your lesson via a link, allowing it to be viewed online.
              </OakP>
            </OakBox>
            <OakBox ref={aiRef}>
              <OakHeading $mb={"space-between-xs"} $font="heading-5" tag="h2">
              ...
              <OakP $mb={"space-between-xs"}>
                ...
                made. Remember, you’re still the expert, so please ensure all
                content is reviewed before using it in a classroom or sharing.
              </OakP>
            </OakBox>
          </OakFlex>
        </OakGridArea>
