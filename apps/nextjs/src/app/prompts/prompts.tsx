      ...
      <OakMaxWidth>
        <HeroContainer>
          <OakBox>
            ...
            <OakP>
              Oak&#39;s AI Experiments aim to test whether high quality
              education content can be generated using existing Large Language
              Models (LLMs). We have created several prompts that are specific
              to the content being generated by AI. Where possible, we also use
              Oak&#39;s content to try to ensure that the outputs are
              pedagogically aligned and to help minimise errors and
              hallucinations. Anyone using the tools will be able to override
              the outputs so that a human is always kept in the loop. We are
              keen to make sure that our work is transparent and the prompts
              that we use in the tools are listed below:
            </OakP>
          </OakBox>
        </HeroContainer>
