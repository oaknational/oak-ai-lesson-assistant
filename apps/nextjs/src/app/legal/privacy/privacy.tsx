    ...
    <Layout>
      <OakBox $pt="inner-padding-l">
        ...
        <OakP $mb="space-between-s">
          If you continue to browse or use this website and the services
          offered, you are agreeing to comply with and be bound by the following
          terms and conditions of use.
        </OakP>
        <OakP $mb="space-between-s">
          The terms “Oak”, “us” and “we” refer to the owner of the website, Oak
          National Academy Limited. The term “you” refers to the user or viewer
          of our website.
        </OakP>
        <OakP $mb="space-between-s">
        ...
        <OakP $mb="space-between-s">
          ...
          updated all the time. We can change or remove material from our
        ...
        <OakP $mb="space-between-s">You agree: </OakP>
        <OakUL $ph="inner-padding-xl">
          ...
          <OakLI $pv="inner-padding-xs">
            not to include any information which could identify an individual
            into any of your inputs (which is defined below);
          </OakLI>
          <OakLI $pv="inner-padding-xs">
            not to engage in any malicious activities, when using our website
            ...
            <OakUL $ph="inner-padding-xl">
              ...
              <OakLI $pv="inner-padding-xs">
                attempting to disrupt or impair the functionality or
        ...
        <OakP $mb="space-between-s">
          We reserve the right to remove or modify your rights to use this
          website and our services if your use does not comply with these terms
          and conditions.
        </OakP>
        ...
        <OakP $mb="space-between-s">
          Subject to your compliance with these Terms and Conditions, we assign
          to you all rights, title and interest in and to output. This means
          that you can use content for any purpose, including commercial
          purposes, such as sale or publication, if you comply with these Terms
          and Conditions.
        </OakP>
        <OakP $mb="space-between-s">
          ...
          <OakUL $ph="inner-padding-xl">
            <OakLI $pv="inner-padding-xs">
              ...
              continuously improve the quality of the outputs and by sharing
              your inputs with us, we can work to fine-tune the Large Language
              Models we work with in order to make them more accurate and better
              at providing content which is helpful to you. We store inputs you
        ...
        <OakP $mb="space-between-s">
          ...
          safe and beneficial to all of our users. You should be aware that use
          of our services may in some situations result in incorrect output
          which does not accurately reflect real people, places or facts. Before
          using the output, you must evaluate its accuracy and determine whether
          it is appropriate for your use case. We recommend that a human should
          always review outputs, to ensure that they are accurate and
        ...
        <OakP $mb="space-between-s">
          The information is licensed “as is” and we exclude all
        ...
        <OakP $mb="space-between-s">
          Whilst warranty or guarantee as to the accuracy, timeliness,
          ...
          omissions, inaccuracies or errors and we expressly exclude liability
          for any such omissions, inaccuracies or errors and we shall not be
          liable for any loss, injury or damage of any kind caused by its use.
        </OakP>

        <OakP $mb="space-between-s">
          Your use of any information or materials on this website or any
          content generated using AI is entirely at your own risk, for which we
          shall not be liable. It shall be your own responsibility to ensure
          that any products, services or information made available through this
          website meet your specific requirements. We are not responsible for
          any decisions or actions taken based on any AI-generated content, and
          we disclaim any liability for damages or losses resulting from your
          reliance on the AI-generated content.
        </OakP>

        <OakP $mb="space-between-s">
          Unauthorised use of this website may lead to a claim for damages
        ...
        <OakP $mb="space-between-s">
          ...
          copyright, trademark and other laws of England and Wales. Our
        ...
        <OakP $mb="space-between-s">
          We make every effort to check and test our website for viruses at
          every stage of production.
        </OakP>
        <OakP $mb="space-between-s">
          You must ensure that the way you use our website does not expose you
          to the risk of viruses, malicious computer code or other forms of
        ...
        <OakP $mb="space-between-s">
          You must not introduce viruses, trojans, worms, logic bombs or any
          other material which is malicious or technologically harmful to our
          website.
        </OakP>
        <OakP $mb="space-between-s">
          You must not attack or try to gain unauthorised access to our website
          or any server, computer or database connected to it. We will report
          any attacks or attempts to the relevant law enforcement authorities.
        </OakP>
        <OakP $mb="space-between-s">
        ...
        <OakP $mb="space-between-s">
          We may decide not to exercise or enforce any right available to us
          under these terms and conditions. We may decide to exercise or enforce
          that right at a later date. Doing this once does not mean that we
        ...
        <OakP $mb="space-between-s">
          Changes to these terms and conditions may be made at any time, so
