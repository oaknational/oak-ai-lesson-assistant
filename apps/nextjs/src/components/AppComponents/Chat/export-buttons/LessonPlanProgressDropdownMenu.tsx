...
type LessonPlanProgressDropdownMenuProps = Readonly<{
...
export const LessonPlanProgressDropdownMenu: React.FC<
  LessonPlanProgressDropdownMenuProps
> = ({ lessonPlan, documentContainerRef, isStreaming, sectionRefs }) => {
