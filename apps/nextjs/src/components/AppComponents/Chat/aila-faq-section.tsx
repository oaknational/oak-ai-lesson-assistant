...
export function AilaFaqSection({ $color }: AilaFaqSectionProps) {
  return (
    <OakBox>
        ...
        >
          <OakP $font="body-2">
            With a general AI tool, you start from a blank chat box and figure
            it out yourself. Aila gives you a structured, teacher-led process
            instead, grounded in{" "}
            <OakLink
              href="https://www.thenational.academy/teachers/curriculum"
              target="_blank"
        ...
        >
          <OakP $font="body-2">
            Thousands of teachers are using Aila to save up to three hours a
            week on lesson planning.
          </OakP>
          <OakP $font="body-2">
