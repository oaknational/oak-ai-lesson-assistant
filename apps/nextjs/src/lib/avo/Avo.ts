// Generated by Avo VERSION 180.20.0. You should never have to make changes to this file.
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro/trigger/Dz17HUwt4
 * 2. User selects the lesson assistant from the hamburger menu
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro/trigger/FlhqUH53S
 * 3. User selects the 'secondary' 'Create a lesson' button/link lower down the labs homepage
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro/trigger/zF4LQ3vWd
 * 4. The user selects the Lesson Planner from the footer menu on the labs homepage
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro/trigger/DLeioZeJ8
 * 5. User clicks on the 'Get started' button from the search results
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro/trigger/LCMU0NPnivcZrJQ58uvzN
 * 
 ...
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/xsOZT-77ro}
 */
 ...
 * When to trigger this event:
 * 1. 
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/6LvrtHjncf/trigger/1MZ802Uxn
 * 2. 
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/6LvrtHjncf/trigger/xgthFuV7v
 * 
 * @param properties the properties associatied with this event
 ...
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/6LvrtHjncf}
 */
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/bpddOGEuH6}
 */
 ...
 * When to trigger this event:
 * 1. 
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/3JLctzBEI/trigger/G_q-2ddJD
 * 
 * @param properties the properties associatied with this event
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/3JLctzBEI}
 */
 ...
 * When to trigger this event:
 * 1. 
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/_SfSF_WDX/trigger/MtMTyJ4g7
 * 
 * @param properties the properties associatied with this event
 * @param properties.componentType: The web component used to carry out the action on the Oak object
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/_SfSF_WDX}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/KbUf1Z4y1/trigger/rsVGVBp2i
 * 2. User types a selection from a list of suggested Oak lessons
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/KbUf1Z4y1/trigger/0IIeoDG3x
 * 3. A user types an edit in the text box and clicks 'send message'
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/KbUf1Z4y1/trigger/PihT6ErP1
 * 4. The user selects one of the radial options and then clicks on 'Modify section'
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/KbUf1Z4y1/trigger/ElTiEFofSw3JMlJMz6I69
 * 
 * @param properties the properties associatied with this event
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/KbUf1Z4y1}
 */
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/v4cCB-DHB}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/fOlHJypRwg/trigger/aV1XekNBLU
 * 
 * @param properties the properties associatied with this event
 ...
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/fOlHJypRwg}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/I_3ZXJv2dxdML9tN8VHYb/trigger/7HC7dZHAPT8KBGGnQOp6C
 * 
 * @param properties the properties associatied with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA and Aila. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * @param properties.isLoggedIn: Flags whether the user logged in or not before accessing the Oak object 
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/I_3ZXJv2dxdML9tN8VHYb}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/53a2df64-53be-4f28-9b3e-2918d78d9477/trigger/G4MY_H0MONSXFiAi_PstL
 * 
 * @param properties the properties associatied with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA and Aila. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/53a2df64-53be-4f28-9b3e-2918d78d9477}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/DZzW7MOE1d7mmFy-3KXnq/trigger/FDM2fVMrZ51mmmXDlsAQw
 * 2. The user clicks on the ‘Create glossary’ button to carry on with the additional resources creation. 
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/DZzW7MOE1d7mmFy-3KXnq/trigger/ELWI6ZF7mpGVF0X_ch4jk
 * 3. The user selects one of the Modify options on the Glossary page
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/DZzW7MOE1d7mmFy-3KXnq/trigger/e3YmT5oE5dvmk9LTbQrqU
 * 4. The user clicks on ‘Back a step’
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/DZzW7MOE1d7mmFy-3KXnq/trigger/0Lqu48jyX2732YmT_-dTc
 * 
 * @param properties the properties associatied with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA and Aila. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * @param properties.moderatedContentType: The flag displayed to the user if the content they are looking at is sensitive/blocked
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/DZzW7MOE1d7mmFy-3KXnq}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/6E7DzaaR8xj-jTMeAu7TS/trigger/pTcRgM36sUy0DWCa6X1kp
 * 
 * @param properties the properties associatied with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA and Aila. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * @param properties.moderatedContentType: The flag displayed to the user if the content they are looking at is sensitive/blocked
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/cl5J_Q1Y_Uf8vI3SJ-53n/events/6E7DzaaR8xj-jTMeAu7TS}
 */
