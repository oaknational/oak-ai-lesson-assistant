// Generated by Avo VERSION 149.1.0. You should never have to make changes to this file.
...
export function lessonPlanResourcesDownloaded(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "3JLctzBEI", "be8229fb18adfe19e36dd8f0abd2b463e756dc0f6158887b78212e88a9f0dc52", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Resources Downloaded", eventProperties, "3JLctzBEI", "be8229fb18adfe19e36dd8f0abd2b463e756dc0f6158887b78212e88a9f0dc52");
    }
    // destination PostHogEU
