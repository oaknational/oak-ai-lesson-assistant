...
export type ModeratedContentTypeValueType =
  ModeratedContentTypeType[keyof ModeratedContentTypeType];
...
export type ResourceFileTypeValueType =
  ResourceFileTypeType[keyof ResourceFileTypeType];
...
export type RefinementTypeValueType =
  RefinementTypeType[keyof RefinementTypeType];
...
export function initAvo(
  ...
  if (!__AVO_NOOP__) {
    ...
    if (__AVO_ENV__ === "prod") {
      PosthogAiBeta &&
        PosthogAiBeta.make &&
        PosthogAiBeta.make(__AVO_ENV__, null);
    } else if (__AVO_ENV__ === "dev") {
      PosthogAiBeta &&
        PosthogAiBeta.make &&
        PosthogAiBeta.make(__AVO_ENV__, null);
      ...
      console[__REPORT_FAILURE_AS__ || "error"](
        "[avo] No staging key is set for Posthog ai-beta. Head to destination settings in Avo to set a staging key.",
      );
      PosthogAiBeta &&
        PosthogAiBeta.make &&
        PosthogAiBeta.make(__AVO_ENV__, null);
...
function assertRefinements(refinements: Refinements[], _label?: string) {
  ...
  messages = messages.concat(
    AvoAssert.assertList("w_NhZWeny", "Refinements", refinements),
  );
  if (
    refinements !== null &&
    ...
    refinements.forEach(function (value, index) {
      messages = messages.concat(
        AvoAssert.assertObject(
          "w_NhZWeny",
          "item at index " + index + " in Refinements",
          value,
        ),
      );
    });
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "xsOZT-77ro",
        "8813f6b5f7a5069c083b03c82bc535434667e0675b85be6b4d2acc7e7e1e5cf9",
        messages.map((m) =>
          Object.assign(
            {},
            {
...
export function lessonPlanInitiated(properties: LessonPlanInitiatedProperties) {
  ...
  properties.moderatedContentType !== undefined &&
  properties.moderatedContentType !== null
    ? eventPropertiesArray.push({
        id: "0NVQREqVg",
        name: "Moderated Content Type",
        value: properties.moderatedContentType,
      })
    : eventPropertiesArray.push({
        id: "0NVQREqVg",
        name: "Moderated Content Type",
  ...
  properties.lessonPlanTitle !== undefined &&
  properties.lessonPlanTitle !== null
    ? eventPropertiesArray.push({
        id: "t0gm_zGXX",
        name: "Lesson Plan Title",
        value: properties.lessonPlanTitle,
      })
    : eventPropertiesArray.push({
        id: "t0gm_zGXX",
        name: "Lesson Plan Title",
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "6LvrtHjncf",
        "ff9daea1c54925979b5aedc36ebafe719873c42d33309c45bff7d0114af8b6af",
        messages.map((m) =>
          Object.assign(
            {},
            {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "bpddOGEuH6",
        "7c84b29ef645df3640506cc411dc57894b1ee4afe090a6cdd61ccbb8954b54b8",
        messages.map((m) =>
          Object.assign(
            {},
            {
...
export function lessonPlanResourcesDownloaded(
  ...
  eventPropertiesArray.push({
    id: "H_kc7WuVNP",
    name: "Resource Type",
    value: properties.resourceType,
  });
  eventPropertiesArray.push({
    id: "6_1GeCgXu",
    name: "Resource File Type",
    value: properties.resourceFileType,
  });
  let eventProperties = convertPropertiesArrayToMap(eventPropertiesArray);
  // @ts-ignore
  let userPropertiesArray: array = [];
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "3JLctzBEI",
        "5e14df101e778bd1f937d759ce067c744b50cc5dcf4d962b3c60aec8dfd571e0",
        messages.map((m) =>
          Object.assign(
            {},
            {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "_SfSF_WDX",
        "d52e541e7d61830980216259863c9cfa656af6435d2d173463a551733f3b1f3f",
        messages.map((m) =>
          Object.assign(
            {},
            {
...
export function lessonPlanRefined(properties: LessonPlanRefinedProperties) {
  ...
  eventPropertiesArray.push({
    id: "w_NhZWeny",
    name: "Refinements",
    value: properties.refinements.map(function (value) {
      return {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "KbUf1Z4y1",
        "9cb0cb62a38549ed7c743b365b1fe50635597f9183b352376b8fb10aa5002d7a",
        messages.map((m) =>
          Object.assign(
            {},
            {
    ...
    if (__AVO_ENV__ !== AvoEnv.Prod && (__STRICT__ === null || __STRICT__)) {
      ...
      if (messages.length !== 0) {
        throw new Error(
          "Error sending event 'Lesson Plan Refined': " + messages[0]!.message,
        );
      }
    } else {
...
export function lessonPlanTerminated(
  ...
  eventPropertiesArray.push({
    ...
    value: properties.isUserBlocked,
  });
  eventPropertiesArray.push({
    id: "DjR2n3j5u",
    name: "Is Toxic Content",
    value: properties.isToxicContent,
  });
  eventPropertiesArray.push({
    id: "GtZ6dCZGc",
    name: "Is Threat Detected",
    value: properties.isThreatDetected,
  });
  let eventProperties = convertPropertiesArrayToMap(eventPropertiesArray);
  // @ts-ignore
  let userPropertiesArray: array = [];
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "v4cCB-DHB",
        "408e6691ea868d0d12f05ab45305a2602308a1baeee3bc4e2e754e52f0a4ca06",
        messages.map((m) =>
          Object.assign(
            {},
            {
