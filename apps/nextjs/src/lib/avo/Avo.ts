...
function assertRefinements(refinements: Refinements[], _label?: string) {
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/xsOZT-77ro/trigger/Dz17HUwt4
 * 2. User selects the lesson assistant from the hamburger menu
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/xsOZT-77ro/trigger/FlhqUH53S
 * 3. User selects the 'secondary' 'Create a lesson' button/link lower down the labs homepage
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/xsOZT-77ro/trigger/zF4LQ3vWd
 * 4. The user selects the Lesson Planner from the footer menu on the labs homepage
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/xsOZT-77ro/trigger/DLeioZeJ8
 *
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/xsOZT-77ro}
 */
export function lessonAssistantAccessed(
  properties: LessonAssistantAccessedProperties) {
  // @ts-ignore
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "xsOZT-77ro", "8813f6b5f7a5069c083b03c82bc535434667e0675b85be6b4d2acc7e7e1e5cf9", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Assistant Accessed", eventProperties, "xsOZT-77ro", "8813f6b5f7a5069c083b03c82bc535434667e0675b85be6b4d2acc7e7e1e5cf9");
    }
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/6LvrtHjncf/trigger/1MZ802Uxn
 * 2.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/6LvrtHjncf/trigger/xgthFuV7v
 *
 * @param properties the properties associatied with this event
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/6LvrtHjncf}
 */
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/bpddOGEuH6}
 */
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/3JLctzBEI/trigger/G_q-2ddJD
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/3JLctzBEI}
 */
export function lessonPlanResourcesDownloaded(
  properties: LessonPlanResourcesDownloadedProperties) {
  // @ts-ignore
  let eventPropertiesArray: array = [];
  properties.subjectSlug !== undefined && properties.subjectSlug !== null ?
    eventPropertiesArray.push({id: "8GyPDAapC-", name: "Subject Slug", value: properties.subjectSlug}) :
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/_SfSF_WDX/trigger/MtMTyJ4g7
 *
 * @param properties the properties associatied with this event
 * @param properties.componentType: The web component used to carry out the action on the Oak object
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/_SfSF_WDX}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/KbUf1Z4y1/trigger/rsVGVBp2i
 * 2. User types a selection from a list of suggested Oak lessons
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/KbUf1Z4y1/trigger/0IIeoDG3x
 * 3. A user types an edit in the text box and clicks 'send message'
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/KbUf1Z4y1/trigger/PihT6ErP1
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/KbUf1Z4y1}
 */
 ...
 * @param properties.chatId: Distinct ID of the Lesson Plan Chat
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/HLxDfOU5-/events/v4cCB-DHB}
 */
export function lessonPlanTerminated(
  properties: LessonPlanTerminatedProperties) {
  // @ts-ignore
  let eventPropertiesArray: array = [];
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["lessonAssistantAccessed","lessonPlanInitiated","lessonPlanCompleted","lessonPlanResourcesDownloaded","lessonPlanShared","lessonPlanRefined","lessonPlanTerminated"]
