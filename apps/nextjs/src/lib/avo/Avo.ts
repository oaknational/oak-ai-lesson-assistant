// Generated by Avo VERSION 169.54.0. You should never have to make changes to this file.
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "xsOZT-77ro", "a3e8cd55c8b707c7b30e0ff062910f039349a86d0f467c697509798cb88587d6", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Assistant Accessed", eventProperties, "xsOZT-77ro", "a3e8cd55c8b707c7b30e0ff062910f039349a86d0f467c697509798cb88587d6");
}
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "6LvrtHjncf", "af9c6852038da57566055d81aa78995551d2f87f5eddbefca520c5abf8210cf2", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Initiated", eventProperties, "6LvrtHjncf", "af9c6852038da57566055d81aa78995551d2f87f5eddbefca520c5abf8210cf2");
}
// destination PostHogEU
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "bpddOGEuH6", "30610b124fdffc468b1b4c3b768ffbd9b7433aaf730da7c830ab59b0ef7e71b9", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Completed", eventProperties, "bpddOGEuH6", "30610b124fdffc468b1b4c3b768ffbd9b7433aaf730da7c830ab59b0ef7e71b9");
}
// destination PostHogEU
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "3JLctzBEI", "a9e6fe6f09d3be9cdc761c860a806fd2e37164ae1c9b9a95173bcd035fa2bf0d", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Resources Downloaded", eventProperties, "3JLctzBEI", "a9e6fe6f09d3be9cdc761c860a806fd2e37164ae1c9b9a95173bcd035fa2bf0d");
}
// destination PostHogEU
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "_SfSF_WDX", "dc030f499bd6b44658d453377b2f5d3eff27a907627199a659d9e2689d1f750a", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Shared", eventProperties, "_SfSF_WDX", "dc030f499bd6b44658d453377b2f5d3eff27a907627199a659d9e2689d1f750a");
}
// destination PostHogEU
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "KbUf1Z4y1", "142a9663374c5950a41b95890a8df88e3594263dc1c8e7239dc238f382a1a9f5", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Plan Refined", eventProperties, "KbUf1Z4y1", "142a9663374c5950a41b95890a8df88e3594263dc1c8e7239dc238f382a1a9f5");
}
// destination PostHogEU
...
if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
  ...
  // debug console in Avo
  if (!__AVO_NOOP__) {
    _avo_invoke(__AVO_ENV__, "fOlHJypRwg", "089429c89ac1b0bfd03a20c355bfed466d080c959bb4fdae22fc74eeee59f260", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
}
...
if (!__AVO_NOOP__) {
  if (__INSPECTOR__ != null) {
    // @ts-ignore
    __INSPECTOR__._avoFunctionTrackSchemaFromEvent("User Sign-Up Completed", eventProperties, "fOlHJypRwg", "089429c89ac1b0bfd03a20c355bfed466d080c959bb4fdae22fc74eeee59f260");
}
// destination PostHogEU
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["lessonAssistantAccessed","lessonPlanInitiated","lessonPlanCompleted","lessonPlanResourcesDownloaded","lessonPlanShared","lessonPlanRefined","lessonPlanTerminated","userSignUpCompleted"]
