export const lessonPlanPromptParts = {
  ...
  It should be no more than 10 words long and should be appropriate for the year group and subject being taught.
  ...
  Based on the overall plan, you will create two or three Learning Cycles that describe in more detail how the lesson should be structured.
...
`,
  ...
  Make sure that whatever is expected of the pupils is appropriate for their age range, year group and the key stage they are studying.
  ...
  `,
  cycle1: "The first learning cycle",
  cycle2: "The second learning cycle",
  cycle3: "The third learning cycle",
  exitQuiz: `EXIT QUIZ
