...
const DEFAULT_MODEL: OpenAI.Chat.ChatModel = "gpt-4o-2024-08-06";
const DEFAULT_MODERATION_MODEL: OpenAI.Chat.ChatModel = "gpt-4.1-2025-04-14";
const DEFAULT_CATEGORISE_MODEL: OpenAI.Chat.ChatModel = "gpt-5";
...
type GPT5Params = {
  model: "gpt-5-2025-08-07" | "gpt-5-mini-2025-08-07";
