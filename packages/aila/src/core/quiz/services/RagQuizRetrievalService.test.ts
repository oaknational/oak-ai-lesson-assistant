...
import { RagQuizRetrievalService } from "./RagQuizRetrievalService";
...
describe("RagQuizRetrievalService", () => {
  let service: RagQuizRetrievalService;
  let mockClient: { search: jest.Mock };

  beforeEach(() => {
    mockClient = createMockClient();
    service = new RagQuizRetrievalService(mockClient as unknown as Client);
    jest.clearAllMocks();
  });
