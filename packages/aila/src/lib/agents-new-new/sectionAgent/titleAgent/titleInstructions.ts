export const titleInstructions = `# Task
Your task is to generate a lesson plan title.
...
You will be provided with some examples from the relevant subject/key-stage to help guide your response.
`;
