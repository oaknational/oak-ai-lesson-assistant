...
- this is not a script!`,
    ...
    imagePrompt: z.string().describe(
      ...
      Do not annotate the image with any text or symbols and the preference is for the image to be photo realistic. 
      ...
      If it is not appropriate or possible to be photo realistic then make that judgment. 
      If it is possible to be photorealistic prefix the prompt with 'A highly detailed 8K photograph of a...'. 
      The end image should be a classroom and age appropriate image.   
      Ensure the prompt is as descriptive as possible.
      The prompt MUST be at least THREE SENTENCES describing the image exactly. 
