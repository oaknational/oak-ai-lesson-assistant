...
import { extractImageUrlsFromText, extractImagesFromQuestion } from "./extractImages";
...
describe("extractImageUrlsFromText", () => {
  ...
  it("should extract multiple images", () => {
    const text = "First ![image1](https://example.com/1.jpg) and second ![image2](https://example.com/2.jpg)";
    const result = extractImageUrlsFromText(text);
  ...
  it("should filter out malformed image syntax", () => {
    const text = "Valid ![image](https://example.com/image.jpg) and invalid ![broken](not-a-url)";
    const result = extractImageUrlsFromText(text);
...
describe("extractImagesFromQuestion", () => {
  ...
  it("should maintain correct index order across different sections", () => {
    const question: QuizV2Question = {
      questionType: "multiple-choice",
      question: "First ![q1](https://example.com/q1.jpg) and second ![q2](https://example.com/q2.jpg)",
