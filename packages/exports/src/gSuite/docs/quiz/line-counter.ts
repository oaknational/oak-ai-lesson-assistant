 ...
 */
export function countQuizLines(questions: QuizV2Question[], debug = false): number {
  let height = 0;
 ...
 */
export function getFooterStrategy(questions: QuizV2Question[]): 'both-footers' | 'global-only' {
