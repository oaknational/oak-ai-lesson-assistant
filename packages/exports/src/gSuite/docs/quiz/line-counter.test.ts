 ...
 */
import { countQuizLines, getFooterStrategy, LINE_COUNT_THRESHOLD } from './line-counter';
...
describe('getFooterStrategy', () => {
  it('should return "both-footers" for content under threshold', () => {
    ...
    const questions: QuizV2Question[] = Array.from({ length: LINE_COUNT_THRESHOLD }, (_, i) => ({
      questionType: 'short-answer',
  ...
  it('should handle edge case at exact threshold', () => {
    ...
    const questions: QuizV2Question[] = Array.from({ length: questionsNeeded }, (_, i) => ({
      questionType: 'short-answer',
      question: `Question ${i + 1}`,
      answers: ['Answer'],
      hint: null
